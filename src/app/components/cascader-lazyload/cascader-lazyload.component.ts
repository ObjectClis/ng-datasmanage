...
@Component({
  selector: 'app-cascader-lazyload',
  templateUrl: './cascader-lazyload.component.html',
  styleUrls: ['./cascader-lazyload.component.css']
})
export class CascaderLazyloadComponent {
